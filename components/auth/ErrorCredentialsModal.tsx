...
interface ErrorCredentialsModalProps {
    visible: boolean;
    onClose: () => void;
}

export default function ErrorCredentialsModal({ visible, onClose }: ErrorCredentialsModalProps) {
        ...
        <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
            <View style={styles.overlay}>
                <View style={styles.content}>
                    ...
                    />
                    <Text style={styles.title}>Credenciales incorrectas</Text>
                    <Text style={styles.subtitle}>El correo electrónico o la contraseña no son correctos.</Text>
                    <TouchableOpacity
