...
export default function MailRegisterModal({
  visible,
  onClose,
  email,
  onResend,
}: MailRegisterModalProps) {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      console.log("Correo reenviado", "Revisa tu bandeja de entrada.");
    } catch (e: any) {
      console.log("Error", e?.message || "No se pudo reenviar el correo.");
    }
    setResending(false);
  };
      ...
      <View style={styles.overlay}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            Abre tu correo electrónico y confirma tu cuenta.
          </Text>
